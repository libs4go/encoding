...
func (encoding *Encoding) decryptKeyV3(
...
func getKDFKey(cryptoJSON cryptoJSON, auth string) ([]byte, error) {
	...
	} else if cryptoJSON.KDF == pbkdf2Name {
...
func initAll() {
	standard = &Encoding{name: "web3.standard", scryptN: standardScryptN, scryptP: standardScryptP}
	light = &Encoding{name: "web3.lisght", scryptN: lightScryptN, scryptP: lightScryptP}
}
